...
Esitys- ja kirjoitusteknisistä syistä rajoitamme tarkastelun $2$-ulotteisiin normaalijakaumiin, vaikka $d$-uloitteisen tapauksen voisi käsitellä samaan tyyliin kuin alla. Ennen $2$-ulotteisen normaalijakauman määrittelemistä voit tarvittaessa kerrata kurssilla *Johdatus data-analytiikkaan* käytyjä perusasioita matriiseista. Tarpeellisia asioita tämän luvun kannalta ovat esimerkiksi $2\times 2$ matriisin determinantti, käänteismatriisi ja matriisikertolasku. Kurssin kannalta tarpeelliset esitiedot matriiseista ja matriiseihin liittyvät notaatiot voit kerrata liitteiden luvusta \@ref(sec:matrix).
