...
\begin{equation*}
  ...
  \exp\left(-\frac{1}{2}\|\boldsymbol x  - \boldsymbol\mu\|^2_{\boldsymbol\Sigma}\right),
  \quad \boldsymbol x\in\mathbb{R}^2,
\end{equation*}
jossa
