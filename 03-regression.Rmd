...
Sovitetun moniulotteisen lineaarisen regrresiomallin avulla voi laskea ennustuksia aivan kuten yhden muuttujan lineaarisen regression tapauksessa. Eli selitettävän muuttujan ennuste $\tilde y$ selitettävien muutujien arvoilla $\tilde x_1, \ldots, \tilde x_d$ saadaan kaavasta
\begin{equation*}
