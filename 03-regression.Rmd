...
- Regressiokertoimien estimaatteihin liittyy paljon epävarmuutta. Tarkemmin ottaen estimaattien $\hat\beta_0, \hat\beta_1, \ldots, \beta_d$ keskivirheet ovat suuria ja selittäjät voivat olla tilastollisesti merkityksettömiä vaikka selitysaste olisi korkea. Estimaatteihin liittyvää epävarmuutta käsitellään tarkemmin luvuissa \@ref(sec:regtesting) ja \@ref(sec:interval).
