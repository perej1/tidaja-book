...
:::{.example}
Vähittäismyyntiketju rakentaa linearisen regressiomallin mallintaakseen tietyn tuotteen kuukausittaista kysyntää (`kysynta`). Kysyntää mallinnetaan seuraavien muuttujien avulla:
...
\end{equation*}
jossa $\boldsymbol v$ on yllä olevaa mallia vastaava virhetermi. Jos $\boldsymbol u = \boldsymbol 0$ selittävää muuttujaa $j$ vastaavalle mallille, niin $\boldsymbol x_j$ on lineaariyhdistelmä muista selittäjistä.
