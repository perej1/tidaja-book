...
b) Jäännöskuvion pisteet ovat jakautuneet tasaisesti kuvaajaan lukuunottamatta yhtä poikkeavaa havaintoa.
    ...
    - *Ratkaisuehdotuksia*: Poikkeavan havainnon voi poistaa, jos sen tiedetään olevan mittausvirhe. Asiantuntijatiedon avulla voidaan myös saada selitys poikkeavalle havainnolle. Eräs ratkaisu voi olla käyttää jotain vakaata estimointimenetelmää kuten pienimmän itsepoikkeaman menetelmää PNS menetelmän sijasta. Pienimmän itsepoikkeaman menetelmässä minimoidaan summaa $\sum_i |y_i - \hat y_i|$. Tällöin poikkeavilla havainnoilla ei ole niin suuru vaikutus esimaattien suuruuteen.

c) Jäänöskuviossa näkyy selkeä deterministinen muoto.
